...
export const generatePI2PDF = (record) => {
        ...
        tableBody.push([
            {
                ...
                styles: { halign: 'left', fontStyle: 'normal', fontSize: 10.5, cellPadding: { top: 2, left: 2, right: 2, bottom: 2 } }
            },
    ...
    // Add description parts at the bottom of the table
    tableBody.push([
        {
    ...
    autoTable(doc, {
        ...
        didDrawCell: (data) => {
            ...
            if (data.section === 'body' && freightRowIndices.includes(data.row.index) && data.column.index >= 1) {
